...
function UploadZone({ label, hint, onChange, disabled, message, fileName }) {
  return (
    <div>
      <span style={S.label}>{label}</span>
      <label style={{ ...S.uploadZone, opacity: disabled ? 0.6 : 1, cursor: disabled ? "not-allowed" : "pointer" }}>
...
function ResultCard({ result}) {
  ...
  return (
    <div style={S.resultCard}>
      ...
      <div style={S.expanderHeader} onClick={() => setOpen(o => !o)}>
      ...
      {open && (
        <div style={{ padding: "16px" }}>
          ...
          <div style={{ border: "1px solid #3d4166", borderRadius: "6px", overflow: "hidden" }}>
            <div
              style={{ ...S.expanderHeader, borderBottom: evidenceOpen ? "1px solid #3d4166" : "none" }}
